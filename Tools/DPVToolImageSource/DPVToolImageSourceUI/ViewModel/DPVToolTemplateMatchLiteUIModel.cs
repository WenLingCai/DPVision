...
namespace DPVToolImageSourceLiteUI.ViewModel
{
    public class DPVToolImageSourceLiteUIModel : INotifyPropertyChanged
    {
        private readonly ITool _tool; // 只持有接口引用
       
        public DPVToolImageSourceLiteUIModel(ITool tool)
        {
            _tool = tool;
